                        ...
                        <div class="product-image">
                            <a href="#">
                                <?php if ($books->image != "") { ?>
                                    <img class="pic-1" src="<?php echo $books->image; ?>">
                                <?php  } else { ?>
                                    <img class="pic-1" src="no_image.jpg">
                                <?php
                                } ?>
                            </a>
                            <ul class="social">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    <div class="product-grid">
                        <div class="product-image">
                            <a href="#">
                                <?php if ($news->image != "") { ?>
                                    <img class="pic-1 " src="<?php echo $news->image; ?>">
                                <?php  } ?>
                            </a>
                        </div>
                        <div class="product-content">
                            <h3 class="title"><a href="/Bookshop/Home/news_details/?id=<?php echo $news->news_id; ?>/"><?php echo $news->name; ?></a></h3>
                        </div>
                    </div>
                </div>
            <?php
